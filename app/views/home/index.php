...
<!-- <div class="w-1/2 relative">
    <div class="">
        <div class="">
            <h1 class="">Hai <?= $data['nama'] ?></h1>
            <p class="">Using a series of utilities, you can create this jumbotron, just like the one in previous versions of Bootstrap. Check out the examples below for how you can remix and restyle it to your liking.</p>
            <button class="" type="button">Example button</button>
        </div>
    </div>
</div> -->

<div id="home" class="isolate bg-white">
        ...
        <div class="relative px-6 lg:px-8">
            <div class="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
                <div>
                    ...
                    <div>
                        <h1 class="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">Short message web to stay in touch</h1>
                        ...
                        <div class="mt-8 flex gap-x-4 sm:justify-center">
                            <a href="#" class="inline-block rounded-lg bg-orange-400 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-orange-400 hover:bg-orange-500 hover:ring-orange-500">
                                Get started
