...
<div class="flex items-center justify-center min-h-screen w-full m-auto p-10">
    <main class="form-signin bg-gray p-5 rounded-md drop-shadow-md">
        <form action="<?= BASEURL; ?>/signup/register" class="flex flex-col gap-3 w-100" method="post">
            ...
            <h1 class="font-semibold mb-3 fw-normal text-xl text-center">Wellcome</h1>
            ...
            <button class="inline-block rounded-lg px-3 py-1.5 text-sm font-semibold leading-6 text-slate-100 shadow-sm hover:bg-orange-500 bg-orange-400" type="submit">Log in</button>
        </form>
    </main>
</div>